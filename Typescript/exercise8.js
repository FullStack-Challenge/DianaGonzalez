...
var logger;
var LoggerFactoy = /** @class */ (function () {
    function LoggerFactoy() {
    }
    LoggerFactoy.getInstance = function () {
        if (!logger) {
...
var logger_ = LoggerFactoy.getInstance();
function simpleLog() {
    return function (target, propertyKey) {
        logger_.log("Calling ".concat(propertyKey));
    };
}
var Item = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function Item() {
                this.itemArr = (__runInitializers(this, _instanceExtraInitializers), void 0);
                this.itemArr = [];
            }
